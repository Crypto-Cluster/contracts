// Official TG: https://t.me/MaticPrintBSC
// Official Website: https://MaticPrintbsc.net
...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        // Solidity only MaticPrintally asserts when dividing by 0
...
contract MaticPrint is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MaticPrint";
    string constant _symbol = "MaticPrint";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = 25* _totalSupply / 10000; // 0.25%
