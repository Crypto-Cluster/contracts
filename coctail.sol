...
contract DancerContract is Ownable {
    ...
    address public marketingWallet = 0x84FB17DC02e646f752A90cD1Af47371603525827;
...
contract Cocktail is ERC20, Ownable {
    ...
    address payable public marketingWallet = 0x84FB17DC02e646f752A90cD1Af47371603525827;
    ...
    constructor() ERC20("BNBUSD", "BNBUSD") {
        ...
        _mint(liquidityWallet, 1000000 * (10**18));
    }
